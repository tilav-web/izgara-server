...
export class CreateCoinSettingsDto {
  @ApiProperty({
    example: 500.0,
    description:
      "1 ta coin'ning puldagi qiymati. Masalan: 1 coin = 500 so'm chegirma.",
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    example: 10000.0,
    description:
      "1 ta coin yig'ish uchun sarflash kerak bo'lgan summa. Masalan: har 10,000 so'mga 1 coin beriladi.",
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    example: 50000.0,
    description:
      "Minimal xarid summasi. Buyurtma summasi bundan kam bo'lsa, coin berilmaydi.",
  })
  @IsNumber()
  @Min(0)
